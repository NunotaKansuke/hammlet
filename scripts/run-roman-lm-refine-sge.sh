...
# Keep the repository and compatibility builds absolute because SGE copies the
# submitted wrapper into its spool directory before execution.
...
exec "${python_bin}" "${repo_dir}/scripts/roman-lm-refine.py" "$@"
